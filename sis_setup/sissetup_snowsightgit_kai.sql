...
CREATE OR REPLACE GIT REPOSITORY git_snowflake_semantic_model_generator
  ...
  ORIGIN = 'https://github.com/gamedatagroup/semantic-model-generator.git';
...
COPY FILES
  INTO @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE
  FROM @KAI_UTILS.PUBLIC.git_snowflake_semantic_model_generator/branches/main/app_utils/
  PATTERN='.*[.]zip';

COPY FILES
  INTO @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator/
  FROM @KAI_UTILS.PUBLIC.git_snowflake_semantic_model_generator/branches/main/
  FILES = ('environment.yml', 'app.py');

COPY FILES
  INTO @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator/semantic_model_generator/
  FROM @KAI_UTILS.PUBLIC.git_snowflake_semantic_model_generator/branches/main/semantic_model_generator/
  PATTERN='.*[.]py';
  
RM @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator/semantic_model_generator/tests;
RM @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator/semantic_model_generator/output_models;

COPY FILES
  INTO @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator/images/
  FROM @KAI_UTILS.PUBLIC.git_snowflake_semantic_model_generator/branches/main/images/
  PATTERN='.*[.]png';

COPY FILES
  INTO @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator/journeys/
  FROM @KAI_UTILS.PUBLIC.git_snowflake_semantic_model_generator/branches/main/journeys/
  PATTERN='.*[.]py';

COPY FILES
  INTO @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator/partner/
  FROM @KAI_UTILS.PUBLIC.git_snowflake_semantic_model_generator/branches/main/partner/
  PATTERN='.*[.]py';

COPY FILES
  INTO @KAI_UTILS.SEMANTIC_MODEL_GENERATOR.STREAMLIT_STAGE/semantic_model_generator/app_utils/
  FROM @KAI_UTILS.PUBLIC.git_snowflake_semantic_model_generator/branches/main/app_utils/
  PATTERN='.*[.]py';
